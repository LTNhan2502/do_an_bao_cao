      ...
      <div class="container">        
        <div class="row">
          <?php
            $kind = new room();
            if($ac == 1){                
                $results = $kind->getSingle();
            }
            while($set = $results->fetch()):
            
          ?>
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
            <a href="index.php?action=detailproduct&id=<?php echo $set['id']; ?>" class="room">
              <figure class="img-wrap">
                <img src="Content/images/<?php echo $set['img']; ?>" alt="Free website template" class="img-fluid mb-3" width="700px" height="700px">
              </figure>
              <div class="p-3 text-center room-info">
                <h2><?php echo $set['name']; ?></h2>
                <span class="text-uppercase letter-spacing-1"><?php echo $set['price']; ?> / per night</span>
              </div>
            </a>
          </div>
          <?php endwhile; ?>
