<?php
    ...
    switch ($act) {
        ...
        case 'check_email':
            ...
            // }
            echo json_encode($countExist);
            break;
        case 'book_room':
            if(isset($_POST['select_room']) && isset($_POST['name']) && isset( $_POST['email_guest']) && 
            isset($_POST['tel']) && isset($_POST['from']) && isset($_POST['to']) && isset($_POST['stay_sum'])){
